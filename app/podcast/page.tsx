...
export default function PodcastPage() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <section>
        <div className="max-w-[1047px] rounded-2xl px-2 md:px-14 py-[70px] bg-gradient-to-b from-[#ffb32c] to-[#b1662b] mt-2 mx-2 md:mx-12">
      ...
      <section className="text-black">
        <div className="container mx-auto flex flex-col items-center justify-center">
          <h2 className="mt-[80px] mb-4 texl-2xl md:text-3xl font-black ">
            Gain startup experience
          </h2>
          <p className="mb-8 md:text-2xl  max-w-[600px] text-center">
            Discover AI startup ideas and connect with potential co-founders
          </p>
        </div>

        <div className="grid grid-cols-1 gap-4 md:gap-12 md:grid-cols-2 w-full max-w-5xl mx-auto px-2 md:px-4">
          {[
            {
            ...
            {
              title: "Meet entrepreneurs and peer  ",
              image: "/Event/Rectangle 35.png",
            },
            {
              title: "Stay up-to-day on trends ",
              image: "/Event/Rectangle 35.png",
            },
            ...
            <div
              key={i}
              className="flex flex-col mx-auto shadow-md pb-[20px] rounded-lg mt-12 bg-[#FEB22C]"
            >
              ...
              <div className="w-full pl-[10px] pt-[10px] flex items-center">
                <div>
                  <h1 className="text-xl md:text-2xl text-black mt-1">
                    {item.title}
                  </h1>
                </div>
              </div>
      ...
      <section className="mt-11 max-w-[1047px] ">
        <div className="flex flex-col w-full mt-10 px-2">
              ...
              >
                ...
                <div className="w-full pl-[10px] h-[40%]">
                  ...
                  <div className="container mx-auto px-1  mt-[20px]">
                    <Button className="bg-[#854836] h-[40px] text-white hover:bg-[#FDBA3C]/90  w-[60%]">
                      View more
                    </Button>
                  </div>
                </div>
        ...
        <div className="flex justify-center w-full">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 w-full max-w-4xl mx-auto px-4">
            {[
              {
                title: "Lorem ipsum",
                image: "/podcast/tyrany.png",
                desc: "Lorem ipsum",
                date: "22nd April",
              },
              {
                title: "Lorem ipsum",
                image: "/podcast/cat.png",
                desc: "Lorem ipsum",
                date: "22nd April",
              },
              {
      ...
      {/* Call to Action */}
      <section className="bg-[#FFB32C] py-20 text-white  max-w-[1047px] rounded-xl mt-[100px] p-12 mb-[100px] mx-[50px]">
        <div className="flex flex-col text-center w-full max-w-[1047px]">
        ...
        <div className="flex flex-col justify-center w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full mx-auto px-1">
            {[
              {
              ...
              <div
                key={i}
                className="flex flex-col w-full mx-auto pb-6 rounded-lg mt-8 mr-2 ml-2"
              >
                {/* Image container */}
