...
export default function AboutPage() {
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-12">
            ...
            <div className="mt-10 md:mt-0 md:w-1/2 space-y-4 text-center md:text-left">
              ...
              <p className="text-base sm:text-lg text-gray-700">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ullamcorper ut leo et, donec tempor massa.
                Ultrices id nam vulputate, eu sociis. Eleifend ullamcorper lobortis nisl ut aliquet et eu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-center md:gap-12 max-w-screen-xl mx-auto">
            ...
            <div className="mt-10 md:mt-0 space-y-8 text-center md:text-left w-full md:w-2/3">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">Why we exist?</h2>
  ...
  <div className="container mx-auto px-4">
    <div className="text-center mb-10 sm:mb-12">
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">Our Team</h2>
      <p className="text-sm sm:text-base text-gray-600">Meet the people behind the mission</p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {[1, 2, 3, 4].map((i) => (
        ...
        >
          ...
          <p className="text-sm font-medium text-gray-600">Role or short bio goes here</p>
        </div>
      ))}
    </div>
  </div>
